(function () {
    ...
    http.$inject = ['$http', '$q', '$timeout', '$localStorage', '$ionicLoading', 'toastr'];
    ...
    function http($http, $q, $timeout, $localStorage, $ionicLoading, toastr) {
        ...
        function request(method, url, data) {
            ...
            if ($localStorage.auth_key) {
                config.url = url + '?auth_key=' + $localStorage.auth_key;
            }
            else {
            config.url = url;
            }
